...
/**
 * An abstract class that implements <i>Vehicle.Movable</i> and extends car, and adds more more specific methods and functionality.
 *
 * <p>
...
public class Car_Transporter <T extends Personal_Car> extends Truck {
     ...
     * Passes most constructor-values to its superclass, Vehicle.Car, but also adds some values unique to this class!
     */
    public Car_Transporter (int capacity) {
        super(2, 500, 0, Color.yellow, "Herpa -Vehicle.Scania CS 20 HD halvsläpvagn X pendel med interdolly Esser tung transport (Nordrhein-Westfalen/Würselen)");
    ...
    /**
     * A method to move the 'flak' of the Vehicle.Car_Transporter up:
     */
    ...
    /**
     * A method that pushes a Vehicle.Car to the Car_transporters local stack.
